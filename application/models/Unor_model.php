...
class Unor_model extends CI_Model {
	...
	var $table = 'unor';
	var $column_order = array('id','unor',null); //set column field database for datatable orderable
	var $column_search = array('id','unor'); //set column field database for datatable searchable just firstname , lastname , address are searchable
