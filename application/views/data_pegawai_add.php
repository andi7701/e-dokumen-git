                ...
                <div class="box-body">
                 <h4><b><u>DATA PRIBADI</u></b></h4>
                   ...
                   <div class="form-group has-feedback"><b>USERNAME:</b><br>
                        <input style="width:600px; max-width:100%;" name="username" type="text" class="form-control" placeholder="USERNAME" maxlength="20"/>
	                </div>
                   ...
                   <div class="form-group has-feedback"><b>NAMA:</b><br>
                        <input style="width:600px; max-width:100%;" name="nama" type="text" class="form-control" placeholder="NAMA" maxlength="80"/>
	                </div>
	               
                   <div class="form-group has-feedback"><b>NIP:</b><br>
                        <input style="width:600px; max-width:100%;" name="nip" type="text" class="form-control" placeholder="NIP" maxlength="21"/>
	                </div>
	                
                   <!-- <div class="form-group has-feedback"><b>OPD:</b><br>
                        <input style="width:600px; max-width:100%;" name="opd" type="text" class="form-control" placeholder="OPD" maxlength="120"/>
	                </div> -->
                   ...
                   <div class="form-group has-feedback"><b>ALAMAT:</b><br>
                      <textarea style="width:600px; max-width:100%;" class="form-control" name="alamat" maxlength="200" placeholder="ALAMAT"></textarea>
	                </div>
	                
	               
                   <div class="form-group has-feedback"><b>NOMOR HP:</b><br>
                        <input style="width:600px; max-width:100%;" name="no_hp" type="text" class="form-control" placeholder="NOMOR HP" maxlength="20"/>
	                </div>
...
function save()
{
	...
	var url;
     url = "<?php echo base_url('data_pegawai/ajax_add')?>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            {	
				...
				window.open ('<?php echo base_url('data_pegawai/view')."/" ?>'+data.id,'_self',false)
            }else{
