...
<section  class="content">
    ...
    <div class="row">
		...
		<a href="<?php echo base_url("data_pegawai/add"); ?>" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo base_url('data_pegawai/ajax_list') ?>",
            "type": "POST"
        },
