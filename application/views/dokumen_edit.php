...
?>
	...
	<?php				
										...
										$this->db->select('*');
										$this->db->where('dokumen.id', $this->uri->segment('3'));											
...
<section class="content-header">
    <h1>
     ...
     >
      <a href="<?php echo base_url('dokumen/view')."/".$id ?>"><b><?php echo $judul ?></b></a>
    </h1>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback"><b>Judul:</b><br>
                        <input value="<?php echo $judul; ?>" style="width:400px; max-width:100%;" name="judul" type="text" class="form-control" placeholder="Judul" maxlength="30"/>
	                </div>
                    <div class="form-group has-feedback"><b>Size Dokumen:</b><br>
                        <input value="<?php echo $size; ?>" style="width:400px; max-width:100%;" name="size" type="text" class="form-control" placeholder="Size file (kb)"/>
                    </div>
...
{
    var url;
     url = "<?php echo base_url('dokumen/ajax_update')."/".$id ?>";
