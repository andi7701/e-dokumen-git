    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
            ...
            <div class="box box-info">
                ...
                <?php
                if($source == 'data_pegawai'){
                    ?> <form action="<?php echo site_url('data_pegawai/tolak_request/'.$id_berkas);?>" id="form" method="post" enctype="multipart/form-data"> <?php
                }elseif($source == 'usul_dokumen'){
                    ?> <form action="<?php echo site_url('usul_dokumen/tolak_request/'.$id_berkas);?>" id="form" method="post" enctype="multipart/form-data"> <?php
                }
                ?>
                ...
                <div class="box-body">
                   ...
                   <div class="form-group has-feedback"><b>KETERANGAN:</b><br>
                        <input style="width:600px; max-width:100%;" name="keterangan" type="text" class="form-control" placeholder="ALASAN PENOLAKAN BERKAS" maxlength="100"/>
	                </div>
