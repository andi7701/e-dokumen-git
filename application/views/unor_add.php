            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                   ...
                   <!-- <div class="form-group has-feedback"><b>Unit:</b><br>
                        <input style="width:400px; max-width:100%;" name="unor" type="text" class="form-control" placeholder="Unit Organisasi" maxlength="120"/>
	                </div> -->
	             <div class="form-group has-feedback"><b>OPD:</b><br>
                        <input style="width:400px; max-width:100%;" name="opd" type="text" class="form-control" placeholder="OPD" maxlength="120"/>
	                </div>  
...
{
    var url;
     url = "<?php echo base_url('unor/ajax_add')?>";
