...
?>
	...
	<?php				
										...
										$this->db->select('*');
										$this->db->where('unor.id', $this->uri->segment('3'));											
...
<section class="content-header">
    <h1>
     ...
     >
      <!-- <a href="<?php echo base_url('unor/view')."/".$id ?>"><b><?php echo $unor ?></b></a> -->
    </h1>
    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                  <!-- <div class="form-group has-feedback"><b>Unit:</b><br>
                        <input value="<?php echo $unor; ?>" style="width:400px; max-width:100%;" name="unor" type="text" class="form-control" placeholder="Unit Organisasi" maxlength="120"/>
	                </div> -->
	            <div class="form-group has-feedback"><b>OPD:</b><br>
                        <input value="<?php echo $opd; ?>" style="width:400px; max-width:100%;" name="opd" type="text" class="form-control" placeholder="OPD" maxlength="120"/>
	                </div> 
		            
                </div>
                <div class="box-footer clearfix">
                    <a href="javascript:window.history.go(-1);" class="pull-left btn btn-info"><i class="fa fa-arrow-circle-left"></i>KEMBALI</a>
                    <button class="pull-right btn btn-info" onclick="save()" type="button">PERBARUI <i class="fa fa-arrow-circle-right"></i></button>
                </div>
				</form>
            </div>
...
{
    var url;
     url = "<?php echo base_url('unor/ajax_update')."/".$id ?>";
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            {	
				...
				window.open ('<?php echo base_url('unor') ?>','_self',false)
            }else{
